...
public class CourseContentInfoView extends LinearLayout {
    private Context mContext;
    private TextView mTvCourseCount;
    private TextView mTvTestCount;
    private TextView mTvSurveyCount;

    public CourseContentInfoView(Context context) {
        super(context);
        mContext = context;
        init();
    }

    public CourseContentInfoView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init();
    }

    public CourseContentInfoView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mContext = context;
        init();
    }

    public CourseContentInfoView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init() {
        View view = View.inflate(mContext, R.layout.view_course_content_info, null);
    ...
    public void setCourseBean(CourseBean bean) {
        if (bean != null) {
